...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r bq_genomics_tools/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg bq_genomics_tools tests/**/*.py
