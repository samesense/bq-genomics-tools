...
import typer
from bq_genomics_tools import __version__
from bq_genomics_tools.example import hello
...
app = typer.Typer(
    ...
    help="Tools for BigQuery variant annotations",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]bq-genomics-tools[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the bq-genomics-tools package.",
    ),
):
